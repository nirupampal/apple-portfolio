...
export default function WorksSection() {
  ...
  return (
    <section id="works" className="relative min-h-screen bg-black py-20 md:py-32 text-white overflow-hidden">
          ...
          <div className="flex flex-wrap gap-4">
            {categories.map((cat) => (
              <button
                ...
                className={`px-6 py-2 rounded-full text-xs uppercase tracking-widest transition-all duration-300 border ${activeFilter === cat
